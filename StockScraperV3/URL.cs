    ...
    public class URL
    {
        ...
        public static async Task<string> ScrapeReportsForCompanyAsync(string companySymbol)
        {
            try
            {
                ...
                using (var driverPool = new ChromeDriverPool(5))
                {
                    ...
                    var filingTypes = new[] { "10-K", "10-Q" }; //  Fetch filings concurrently (10-K and 10-Q)
        ...
        public static async Task RunScraperForUnscrapedCompaniesAsync()
        {
            try
            {
                ...
                var unscrapedCompanies = await GetUnscrapedCompaniesFromDatabase();// 1. Retrieve all unscraped companies from the database.
                ...
                using (var driverPool = new ChromeDriverPool(5))
                {
                    ...
                    foreach (var company in unscrapedCompanies)
                    {
                        ...
                        var filingTasks = new[]// 6. Fetch filings concurrently (10-K and 10-Q)
                        {
