...
namespace DataElements
{
    public static class FinancialElementLists
    {
        ...
        {
            "CashAndCashEquivalentsAtCarryingValue", "Assets", "Liabilities", "StockholdersEquity", "MarketableSecuritiesCurrent", 
            "AccountsReceivableNetCurrent", "NontradeReceivablesCurrent", "InventoryNet", "OtherAssetsCurrent", "AssetsCurrent", 
            "MarketableSecuritiesNoncurrent", "PropertyPlantAndEquipmentNet", "OtherAssetsNoncurrent", "AssetsNoncurrent", "AccountsPayableCurrent",
            "OtherLiabilitiesCurrent", "ContractWithCustomerLiabilityCurrent", "CommercialPaper", "LongTermDebtCurrent", "LiabilitiesCurrent",
            "LongTermDebtNoncurrent", "OtherLiabilitiesNoncurrent", "LiabilitiesNoncurrent", "Liabilities", "CommitmentsAndContingencies",
            "CommonStockSharesIssued", "CommonStockSharesOutstanding", "RetainedEarningsAccumulatedDeficit",
            "AccumulatedOtherComprehensiveIncomeLossNetOfTax", "StockholdersEquity", "LiabilitiesAndStockholdersEquity",
            "CashCashEquivalentsRestrictedCashAndRestrictedCashEquivalents", "EquitySecuritiesFvNiCost",
            "EquitySecuritiesFVNIAccumulatedGrossUnrealizedGainBeforeTax", "EquitySecuritiesFVNIAccumulatedGrossUnrealizedLossBeforeTax",
            "EquitySecuritiesFvNiCurrentAndNoncurrent", "AvailableForSaleDebtSecuritiesAmortizedCostBasis",
            "AvailableForSaleDebtSecuritiesAccumulatedGrossUnrealizedGainBeforeTax", "AvailableForSaleSecuritiesDebtSecurities", 
            "AvailableForSaleDebtSecuritiesAccumulatedGrossUnrealizedLossBeforeTax", "CashCashEquivalentsAndMarketableSecuritiesCost",
            "CashEquivalentsAndMarketableSecuritiesAccumulatedGrossUnrealizedGainBeforeTax","CashCashEquivalentsAndMarketableSecurities", "Cash"
        };
        ...
        public static HashSet<string> ElementsOfInterest { get; } = new HashSet<string>
        {
            ...
            "RevenueFromContractWithCustomerExcludingAssessedTax", "GrossProfit", "ResearchAndDevelopmentExpense", 
            "SellingGeneralAndAdministrativeExpense", "OperatingExpenses", "NonoperatingIncomeExpense",
            "IncomeLossFromContinuingOperationsBeforeIncomeTaxesExtraordinaryItemsNoncontrollingInterest", "IncomeTaxExpenseBenefit", 
            "NetIncomeLoss", "EarningsPerShareBasic", "EarningsPerShareDiluted", "WeightedAverageNumberOfSharesOutstandingBasic",
            "WeightedAverageNumberOfDilutedSharesOutstanding", 
            "OtherComprehensiveIncomeLossForeignCurrencyTransactionAndTranslationAdjustmentNetOfTax",
            "OtherComprehensiveIncomeUnrealizedHoldingGainLossOnSecuritiesArisingDuringPeriodNetOfTax",
            "OtherComprehensiveIncomeLossAvailableForSaleSecuritiesAdjustmentNetOfTax",
            "OtherComprehensiveIncomeLossNetOfTaxPortionAttributableToParent", "ComprehensiveIncomeNetOfTax", 
            ...
            "InventoryNet", "OtherAssetsCurrent", "AssetsCurrent", "MarketableSecuritiesNoncurrent", "PropertyPlantAndEquipmentNet",
            "OtherAssetsNoncurrent", "AssetsNoncurrent", "Assets", "AccountsPayableCurrent", "OtherLiabilitiesCurrent", 
            "ContractWithCustomerLiabilityCurrent", "CommercialPaper", "LongTermDebtCurrent", "LiabilitiesCurrent",
            "LongTermDebtNoncurrent", "OtherLiabilitiesNoncurrent", "LiabilitiesNoncurrent", "Liabilities", "CommitmentsAndContingencies",
            "CommonStockSharesIssued", "CommonStockSharesOutstanding", "RetainedEarningsAccumulatedDeficit", "AccumulatedOtherComprehensiveIncomeLossNetOfTax", 
            "StockholdersEquity", "LiabilitiesAndStockholdersEquity", "StockIssuedDuringPeriodValueNewIssues", "Dividends", 
            "StockRepurchasedAndRetiredDuringPeriodValue", "CommonStockDividendsPerShareDeclared", 
            "CashCashEquivalentsRestrictedCashAndRestrictedCashEquivalents", "DepreciationDepletionAndAmortization", "ShareBasedCompensation",
            "OtherNoncashIncomeExpense", "IncreaseDecreaseInAccountsReceivable", "IncreaseDecreaseInInventories", 
            "IncreaseDecreaseInOtherOperatingAssets", "IncreaseDecreaseInAccountsPayable", "IncreaseDecreaseInOtherOperatingLiabilities",
            "NetCashProvidedByUsedInOperatingActivities", "PaymentsToAcquireAvailableForSaleSecuritiesDebt",
            "ProceedsFromMaturitiesPrepaymentsAndCallsOfAvailableForSaleSecurities", "PaymentsToAcquirePropertyPlantAndEquipment",
            "PaymentsForProceedsFromOtherInvestingActivities", "NetCashProvidedByUsedInInvestingActivities",
            "PaymentsOfDividends", "PaymentsForRepurchaseOfCommonStock", "RepaymentsOfLongTermDebt", "ProceedsFromRepaymentsOfCommercialPaper",
            "ProceedsFromPaymentsForOtherFinancingActivities", "NetCashProvidedByUsedInFinancingActivities", "IncomeTaxesPaidNet",
            "EquitySecuritiesFvNiCost", "EquitySecuritiesFVNIAccumulatedGrossUnrealizedGainBeforeTax",
            "EquitySecuritiesFVNIAccumulatedGrossUnrealizedLossBeforeTax", "EquitySecuritiesFvNiCurrentAndNoncurrent",
            "AvailableForSaleDebtSecuritiesAmortizedCostBasis", "AvailableForSaleDebtSecuritiesAccumulatedGrossUnrealizedGainBeforeTax",
            "AvailableForSaleSecuritiesDebtSecurities", "AvailableForSaleDebtSecuritiesAccumulatedGrossUnrealizedLossBeforeTax",
            "CashCashEquivalentsAndMarketableSecuritiesCost", "CashEquivalentsAndMarketableSecuritiesAccumulatedGrossUnrealizedGainBeforeTax",
