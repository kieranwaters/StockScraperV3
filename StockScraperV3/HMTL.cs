                ...
                foreach (var table in tables)
                {
                    ...
                    foreach (var row in rows)
                    {
                        ...
                        if (valueCell != null)
                        {
                            ...
                            {
                                Console.WriteLine($"[WARNING] Unable to parse value '{cleanedValue}' for element '{label}'.");
                                continue;
                            }
                            ...
                            Console.WriteLine($"[DEBUG] Assigned {elementName} = {value} for CompanyID: {companyId}");
                        }
                    }
